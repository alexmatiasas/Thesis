...
\begin{figure}[h]
    ...
    \draw[dashedarrow] (interpretation.east) -- ++(0.5,0) |- node[pos=0.25, above] {Afecta} (entropy.west);
    ...
    \node[below=0.8cm of interpretation, text width=5cm, align=left, font=\small] {
        ...
        \begin{enumerate}[a)]
            \item El parámetro $q$ modifica la entropía
            \item La entropía generalizada afecta la presión
            \item Todo converge a BG cuando $q=1$
        \end{enumerate}
    };
    \end{tikzpicture}
